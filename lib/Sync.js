...
var temp = function(i){
    ...
    this.sync = function(callback, _continue){
        ...
        callback(function(){
            ...
            if(arguments[error_key] instanceof Error) return self.throw(arguments[key], _continue, results)
    ...
    this.async.each = function(array, func, _continue){
        ...
        var cb = function(){
            ...
            if(arguments[key] instanceof Error) {
                ...
                return self.throw(arguments[key], _continue, results) 
